...
import (
	...
	"github.com/azon0320/fireplace/pkg/logging"
...
func main() {
	...
	mgoURL := os.Getenv("MONGO_URL")
	serveAddress := os.Getenv("SERVER_ADDRESS")
	...
	go func() {
		...
		logger.WithField("host", serveAddress).Infof("Starting Fireplace Server v%s", SERVER_VERSION)

		if err = httpServer.Start(serveAddress); err != nil {
